...
public class ResultList extends ArrayList<HashMap<String,Object>>{
	...
	/**
	 * Sets the error on the executed sql statement
	 * @param e - The error that occured on the sql statment
	 */
	...
	/**
	 * The return of the sql error that occured on the statement
	 * @return error - The Exception on the SQL statment
	 */
